...
const IndiForum = (props) => {
    ...
    useEffect(() => {
        fetch(`http://localhost:5000/api/comments/forumID/${props.indiForumId}`)
    ...
    return <div>
        <Modal>
            <div className="indiForum__BaseContent">
                <div className="indiForum__creator">Creator: {props.indiForumCreator}</div>
                <div className="indiForum__headline">Headline: {props.indiForumHeadline}</div>
